...
import { DivContainer,DivHeaderSignup , HeaderOval,LogoOval , DivContainerLogin,PText, BlueText , DivInput, TextInput, InputLock, InputUser } from './style' 
...
function LoginPage() {
  ...
  e.preventDefault();
await  signup(form, cleanFields, Navigate);
  };
  ...
  return (
    ...
    <DivContainer>
      ...
      <DivHeaderSignup>
      <HeaderOval src={ovalBG}
      alt={"Oval Image"}
      />
      <LogoOval src={logoPNG} 
       alt={"LinsMarket Logo"}
      ...
      <PText>Já tem uma conta ? <BlueText onClick={() => goToPage(Navigate, "login")}>Entre !</BlueText></PText>
